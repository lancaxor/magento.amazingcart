...
class ResponseFormatter
{
    ...
    public function formatCustomerData($customerInfo) {
        ...
        $formattedShipping = [
            ...
            'shipping_address_1' => ($correctShipping && isset($shipping->getStreet()[0])) ? $shipping->getStreet()[0] : '',
            'shipping_address_2' => ($correctShipping && isset($shipping->getStreet()[1])) ? $shipping->getStreet()[1] : '',
        ...
        $formattedBilling = [
            ...
            'billing_address_1'     => ($correctBilling && isset($billing->getStreet()[0])) ? $billing->getStreet()[0] : '',
            'billing_address_2'     => ($correctBilling && isset($billing->getStreet()[1])) ? $billing->getStreet()[1] : '',
